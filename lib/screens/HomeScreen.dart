  ...
  void _togglePurchase(String eventId) {
    ...
    setState(() {
      if (purchasedEventIds.contains(eventId)) {
        ...
        Provider.of<Cart>(context, listen: false).removeItemFromCartById(
            Provider.of<UserNotifier>(context, listen: false).userLogado,
            eventId);
      } else {
        purchasedEventIds.add(eventId);
        //print(purchasedEventIds);
        Provider.of<Cart>(context, listen: false).addItemFromCartById(
            Provider.of<UserNotifier>(context, listen: false).userLogado,
            eventId);
      }
                ...
                children: [
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      bool isPurchased = purchasedEventIds.contains(event.id);
                      return EventCard(
                        id: event.id,
                        date: event.date,
                        price: event.price,
